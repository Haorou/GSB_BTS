...
namespace GSB.Models.DAO
{
    ...
    {
        public List<LigneFrais> ReadAllFromFicheFrais(FicheFrais ficheFrais)
        {
            List<LigneFrais> list_fiche_frais = new List<LigneFrais>();
            if (OpenConnection())
            {
                LigneFrais ligne_frais = new LigneFrais();
                ...
                while (dataReader.Read())
                {
                    ...
                    ligne_frais.Justificatif = (string)dataReader["justificatif"];
